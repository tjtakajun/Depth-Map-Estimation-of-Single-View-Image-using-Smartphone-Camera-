...
public class ImageCropperRE : MonoBehaviour
{
	...
	private static ImageCropperRE m_instance = null;
	public static ImageCropperRE Instance
	{
		get
		{
			if( m_instance == null )
				m_instance = Instantiate( Resources.Load<ImageCropperRE>( "ImageCropperRE" ) );
